...
export const ROLE_VIEW_MODULES = {
  'Super Admin': '*',
  'Company Owner': '*',
  'Manager': [...COMMON, M.CATEGORIES, M.BRANDS, M.PRODUCTS, M.SUPPLIERS, M.WAREHOUSES, M.INVENTORY, M.STOCK_TRANSFER, M.PRODUCT_SEARCH, M.ENQUIRIES, M.ORDERS, M.DISPATCHES, M.CUSTOMERS, M.LEADS, M.FOLLOWUPS, M.EMPLOYEE_MANAGEMENT, M.ATTENDANCE, M.REPORT_CENTER],
  'Accountant': [...COMMON, M.SUPPLIERS, M.PURCHASES, M.CUSTOMERS, M.QUOTATIONS, M.INVOICES, M.SALES, M.EXPENSES, M.PAYMENTS, M.ACCOUNTS, M.PROFIT_LOSS, M.REPORT_CENTER, M.DOCUMENTS],
  'Sales Executive': [...COMMON, M.PRODUCT_SEARCH, M.ENQUIRIES, M.ORDERS, M.CUSTOMERS, M.LEADS, M.FOLLOWUPS, M.QUOTATIONS],
  'Warehouse Staff': [...COMMON, M.PRODUCT_SEARCH, M.WAREHOUSES, M.INVENTORY, M.STOCK_TRANSFER, M.ORDERS, M.DISPATCHES],
  'Retailer': [...COMMON, M.PRODUCT_SEARCH, M.ENQUIRIES, M.ORDERS],
  'Wholesaler': [...COMMON, M.PRODUCT_SEARCH, M.PRODUCTS, M.INVENTORY, M.ENQUIRIES, M.ORDERS],
}
