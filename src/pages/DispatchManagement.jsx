...
export default function DispatchManagement({ dispatches = [], orders = [], markDelivered }) {
          ...
          <table>
            <thead>
              <tr>
                ...
                <th>Dispatch Date</th><th>Exp. Delivery</th><th>Delivered On</th>
            ...
            <tbody>
              ...
              {filtered.length === 0 && (
                <tr><td colSpan={13} style={{ textAlign: 'center', padding: 24, color: 'var(--text-muted)' }}>No dispatches found</td></tr>
              )}
            </tbody>
          </table>
        </div>
